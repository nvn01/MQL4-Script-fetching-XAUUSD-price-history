//+------------------------------------------------------------------+
//|                                   ExportXAUUSD_1m_Data.mq4       |
//|  This script exports XAUUSD data from January 1, 2004 onward for   |
//|  the 1-minute timeframe, saving it as XAU_1m_data.csv              |
//+------------------------------------------------------------------+
#property strict
...
void OnStart()
{
   // Define the symbol and the start date (January 1, 2004)
   string symbol = "XAUUSD";
   datetime startTime = StrToTime("2004.01.01 00:00");
   
   // Define the file name for the 1-minute timeframe data
   string fileName = "XAU_1m_data.csv";
   
   // Export data for the 1-minute timeframe
   ExportData(symbol, PERIOD_M1, fileName, startTime);
}
